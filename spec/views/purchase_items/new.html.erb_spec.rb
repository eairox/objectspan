...
describe "purchase_items/new" do
  before(:each) do
    assign(:purchase_item, stub_model(PurchaseItem,
      :item_id => 1,
      :quantity => 1.5,
  ...
  it "renders new purchase_item form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => purchase_items_path, :method => "post" do
