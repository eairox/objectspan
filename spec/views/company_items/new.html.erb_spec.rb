...
describe "company_items/new" do
  before(:each) do
    assign(:company_item, stub_model(CompanyItem,
      :company_id => 1,
      :item_id => 1,
      :sku => "MyString",
      :price => 1.5,
  ...
  it "renders new company_item form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => company_items_path, :method => "post" do
