...
describe "purchase_feedbacks/edit" do
  before(:each) do
  ...
  it "renders the edit purchase_feedback form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => purchase_feedbacks_path(@purchase_feedback), :method => "post" do
