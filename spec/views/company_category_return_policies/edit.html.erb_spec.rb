...
describe "company_category_return_policies/edit" do
  before(:each) do
  ...
  it "renders the edit company_category_return_policy form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => company_category_return_policies_path(@company_category_return_policy), :method => "post" do
